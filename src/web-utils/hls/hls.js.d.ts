...
declare class Hls {
  ...
  on(
    ...
    callback: (event: K_MEDIA_ATTACHING, data: Hls.mediaAttachedData) => void,
  ): void;
  on(
    event: K_MEDIA_ATTACHED,
    callback: (event: K_MEDIA_ATTACHED, data: Hls.mediaAttachedData) => void,
  ): void;
  on(
    event: K_MEDIA_DETACHING,
    callback: (event: K_MEDIA_DETACHING, data: {}) => void,
  ): void;
  on(
    event: K_MEDIA_DETACHED,
    callback: (event: K_MEDIA_DETACHED, data: {}) => void,
  ): void;
  on(
    event: K_BUFFER_RESET,
    callback: (event: K_BUFFER_RESET, data: {}) => void,
  ): void;
  on(
    event: K_BUFFER_CODECS,
    callback: (event: K_BUFFER_CODECS, data: Hls.bufferCodecsData) => void,
  ): void;
  on(
    event: K_BUFFER_CREATED,
    callback: (event: K_BUFFER_CREATED, data: Hls.bufferCreatedData) => void,
  ): void;
  on(
    event: K_BUFFER_APPENDING,
    callback: (
      event: K_BUFFER_APPENDING,
      data: Hls.bufferAppendingData,
    ) => void,
  ): void;
  on(
    event: K_BUFFER_APPENDED,
    callback: (event: K_BUFFER_APPENDED, data: Hls.bufferAppendedData) => void,
  ): void;
  on(
    event: K_BUFFER_EOS,
    callback: (event: K_BUFFER_EOS, data: {}) => void,
  ): void;
  on(
    event: K_BUFFER_FLUSHING,
    callback: (event: K_BUFFER_FLUSHING, data: Hls.bufferFlushingData) => void,
  ): void;
  on(
    event: K_BUFFER_FLUSHED,
    callback: (event: K_BUFFER_FLUSHED, data: Hls.bufferFlushedData) => void,
  ): void;
  on(
    event: K_MANIFEST_LOADING,
    callback: (
      event: K_MANIFEST_LOADING,
      data: Hls.manifestLoadingData,
    ) => void,
  ): void;
  on(
    event: K_MANIFEST_LOADED,
    callback: (event: K_MANIFEST_LOADED, data: Hls.manifestLoadedData) => void,
  ): void;
  on(
    event: K_MANIFEST_PARSED,
    callback: (event: K_MANIFEST_PARSED, data: Hls.manifestParsedData) => void,
  ): void;
  on(
    event: K_LEVEL_SWITCHING,
    callback: (event: K_LEVEL_SWITCHING, data: Hls.levelSwitchingData) => void,
  ): void;
  on(
    event: K_LEVEL_SWITCHED,
    callback: (event: K_LEVEL_SWITCHED, data: Hls.levelSwitchedData) => void,
  ): void;
  on(
    event: K_LEVEL_LOADING,
    callback: (event: K_LEVEL_LOADING, data: Hls.levelLoadingData) => void,
  ): void;
  on(
    event: K_LEVEL_LOADED,
    callback: (event: K_LEVEL_LOADED, data: Hls.levelLoadedData) => void,
  ): void;
  on(
    event: K_LEVEL_UPDATED,
    callback: (event: K_LEVEL_UPDATED, data: Hls.levelUpdatedData) => void,
  ): void;
  on(
    event: K_LEVEL_PTS_UPDATED,
    callback: (
      event: K_LEVEL_PTS_UPDATED,
      data: Hls.levelPtsUpdatedData,
    ) => void,
  ): void;
  on(
  ...
  on(
    ...
    callback: (
      event: K_AUDIO_TRACK_LOADING,
      data: Hls.audioTrackLoadingData,
    ) => void,
  ): void;
  on(
  ...
  on(
    ...
    callback: (
      event: K_SUBTITLE_TRACKS_UPDATED,
      data: Hls.subtitleTracksUpdatedData,
    ) => void,
  ): void;
  on(
    ...
    callback: (
      event: K_SUBTITLE_TRACK_SWITCH,
      data: Hls.subtitleTrackSwitchData,
    ) => void,
  ): void;
  on(
    ...
    callback: (
      event: K_SUBTITLE_TRACK_LOADING,
      data: Hls.subtitleTrackLoadingData,
    ) => void,
  ): void;
  on(
    ...
    callback: (
      event: K_SUBTITLE_TRACK_LOADED,
      data: Hls.subtitleTrackLoadedData,
    ) => void,
  ): void;
  on(
    ...
    callback: (
      event: K_SUBTITLE_FRAG_PROCESSED,
      data: Hls.subtitleFragProcessedData,
    ) => void,
  ): void;
  on(
    event: K_INIT_PTS_FOUND,
    callback: (event: K_INIT_PTS_FOUND, data: Hls.initPtsFoundData) => void,
  ): void;
  on(
    event: K_FRAG_LOADING,
    callback: (event: K_FRAG_LOADING, data: Hls.fragLoadingData) => void,
  ): void;
  on(
    event: K_FRAG_LOAD_PROGRESS,
    callback: (
      event: K_FRAG_LOAD_PROGRESS,
      data: Hls.fragLoadProgressData,
    ) => void,
  ): void;
  on(
  ...
  on(
    event: K_FRAG_LOADED,
    callback: (event: K_FRAG_LOADED, data: Hls.fragLoadedData) => void,
  ): void;
  on(
    event: K_FRAG_DECRYPTED,
    callback: (event: K_FRAG_DECRYPTED, data: Hls.fragDecryptedData) => void,
  ): void;
  on(
  ...
  on(
    ...
    callback: (
      event: K_FRAG_PARSING_METADATA,
      data: Hls.fragParsingMetadata,
    ) => void,
  ): void;
  on(
    event: K_FRAG_PARSING_DATA,
    callback: (event: K_FRAG_PARSING_DATA, data: Hls.fragParsingData) => void,
  ): void;
  on(
    event: K_FRAG_PARSED,
    callback: (event: K_FRAG_PARSED, data: Hls.fragParsedData) => void,
  ): void;
  on(
    event: K_FRAG_BUFFERED,
    callback: (event: K_FRAG_BUFFERED, data: Hls.fragBufferedData) => void,
  ): void;
  on(
    event: K_FRAG_CHANGED,
    callback: (event: K_FRAG_CHANGED, data: Hls.fragChangedData) => void,
  ): void;
  on(
    event: K_FPS_DROP,
    callback: (event: K_FPS_DROP, data: Hls.fpsDropData) => void,
  ): void;
  on(
    event: K_FPS_DROP_LEVEL_CAPPING,
    callback: (
      event: K_FPS_DROP_LEVEL_CAPPING,
      data: Hls.fpsDropLevelCappingData,
    ) => void,
  ): void;
  on(
    event: K_ERROR,
    callback: (event: K_ERROR, data: Hls.errorData) => void,
  ): void;
  on(
    event: K_DESTROYING,
    callback: (event: K_DESTROYING, data: {}) => void,
  ): void;
  on(
    event: K_KEY_LOADING,
    callback: (event: K_KEY_LOADING, data: Hls.keyLoadingData) => void,
  ): void;
  on(
    event: K_KEY_LOADED,
    callback: (event: K_KEY_LOADED, data: Hls.keyLoadedData) => void,
  ): void;
  on(
    event: K_STREAM_STATE_TRANSITION,
    callback: (
      event: K_STREAM_STATE_TRANSITION,
      data: Hls.streamStateTransitionData,
    ) => void,
  ): void;
  /**
