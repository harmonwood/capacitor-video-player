...
| **`displayMode`**     | <code>string</code>                                         | Display Mode ["portrait", "landscape"] (iOS, Android) default: "all"                                                                                   |
...
| **`title`**           | <code>string</code>                                         | Title shown in the player (Android) and in NowPlayingInfo center (iOS) by Manuel García Marín (https://github.com/PhantomPainX)                 |
| **`smallTitle`**      | <code>string</code>                                         | Subtitle shown below the title in the player (Android) and in NowPlayingInfo center (iOS) by Manuel García Marín (https://github.com/PhantomPainX)             |
...
| **`artwork`**         | <code>string</code>                                         | Artwork url to be shown in Chromecast player (Android) and in NowPlayingInfo center (iOS) by Manuel García Marín (https://github.com/PhantomPainX) default: ""                      |
