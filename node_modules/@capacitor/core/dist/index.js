...
exports.Capacitor = new CapacitorWeb();
exports.Capacitor = window.Capacitor || exports.Capacitor;
// Export window.Capacitor if not available already (ex: web)
if (!window.Capacitor) {
    window.Capacitor = exports.Capacitor;
}
var Plugins = exports.Capacitor.Plugins;
