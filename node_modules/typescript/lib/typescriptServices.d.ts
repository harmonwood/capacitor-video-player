...
declare namespace ts {
  ...
  function createTupleTypeNode(
    elementTypes: readonly TypeNode[],
  ): TupleTypeNode;
  ...
  /** @deprecated */ function createTaggedTemplate(
    tag: Expression,
    template: TemplateLiteral,
  ): TaggedTemplateExpression;
  ...
  /** @deprecated */ function updateTaggedTemplate(
  ...
  /** @deprecated */ function createConditional(
    condition: Expression,
    whenTrue: Expression,
    whenFalse: Expression,
  ...
  function createNullishCoalesce(
    left: Expression,
    right: Expression,
  ): BinaryExpression;
